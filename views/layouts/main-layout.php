...
<div class="container">
	<div class="header pt-3 mb-2">
		<div class="row align-items-center pb-3 mb-3 border-bottom">
			...
			<div class="col-6 d-flex align-items-center header__logout">
				<span class="header__my-name text-muted ml-auto mr-4"><?= Yii::$app->user->identity->name ?></span>
				<?= Html::a('Выйти', Url::to(['user/logout']), ['class' => 'btn btn-outline-info']) ?>
			</div>
		</div>
		<div class="row mb-4">
			<div class="col-12 menu header__menu">
				<div class="nav nav-pills">
					<?= Html::a('Задачи', Url::home(), ['class' => 'nav-item nav-link bg-info text-white mr-2']) ?>
				</div>
			</div>
		</div>
	</div>
